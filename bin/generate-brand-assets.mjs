...
const frames = [16, 32, 48].map(size => execFileSync("rsvg-convert", ["-w", String(size), "-h", String(size)], { input: source }));
output("app/favicon.ico", execFileSync("magick", ["png:-", "ico:-"], { input: Buffer.concat(frames) }));
